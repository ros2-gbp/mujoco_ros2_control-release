...
%global pkg_name mujoco_ros2_control_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-mujoco-ros2-control-msgs
Version:        0.1.2
Release:        1%{?dist}
...
%description
msgs for mujoco_ros2_control package
...
* Wed Apr 29 2026 Nathan Dunkelberger <nathan.b.dunkelberger@nasa.gov> - 0.0.2-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Nathan Dunkelberger <nathan.b.dunkelberger@nasa.gov> - 0.0.2-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Nathan Dunkelberger <nathan.b.dunkelberger@nasa.gov> - 0.0.2-1
- Autogenerated by Bloom
